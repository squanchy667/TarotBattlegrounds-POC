-- =====================================================
-- TAROT BATTLEGROUNDS - AMAZON ATHENA SEED DATA
-- =====================================================
...
-- =====================================================
-- CARDS - PENTACLES (Earth) - 12 cards
-- =====================================================
...
-- =====================================================
-- CARDS - HYBRID (Multi-tribe) - 5 cards
-- =====================================================
...
-- =====================================================
-- CARDS - NEUTRAL (Major Arcana) - 6 cards
-- =====================================================
...
-- Alchemist (49): Wands + Pentacles
INSERT INTO card_tribes (card_id, tribe_id, is_primary) VALUES
(49, 1, true), (49, 4, false);

-- Battle Cleric (50): Cups + Swords
INSERT INTO card_tribes (card_id, tribe_id, is_primary) VALUES
(50, 2, true), (50, 3, false);

-- Spellsword (51): Swords + Wands
INSERT INTO card_tribes (card_id, tribe_id, is_primary) VALUES
(51, 3, true), (51, 1, false);

-- Earth Shaman (52): Pentacles + Cups
INSERT INTO card_tribes (card_id, tribe_id, is_primary) VALUES
(52, 4, true), (52, 2, false);

-- Avatar of Balance (53): All four tribes
INSERT INTO card_tribes (card_id, tribe_id, is_primary) VALUES
(53, 1, true), (53, 2, false), (53, 3, false), (53, 4, false);
